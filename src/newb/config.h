...
#define NL_RAIN_MIST_OPACITY 0.13 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist 
...
#define NL_RAINBOW_CLEAR 0.24 // 0.3 subtle ~ 1.7 bright during clear
...
#define NL_CLOUD0_THICKNESS 1.4      // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_RAIN_THICKNESS 1.3 // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_OPACITY 1.8

/* Soft cloud settings */
#define NL_CLOUD1_SCALE vec2(0.026, 0.032) // 0.003 large ~ 0.2 tiny
#define NL_CLOUD1_DEPTH 1.4                // 0.0 no bump ~ 10.0 large bumps
#define NL_CLOUD1_SPEED 0.08               // 0.0 static ~ 0.4 fast moving
#define NL_CLOUD1_DENSITY 5.0             // 0.1 less clouds ~ 0.8 more clouds
